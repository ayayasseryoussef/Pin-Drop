...
//   static const double liftHeight = -32;
...
//     // dropAnim = TweenSequence([
//     //   TweenSequenceItem(
//     //     tween: Tween(begin: liftHeight, end: 6)
...
//     // shadowScale = TweenSequence([
//     //   TweenSequenceItem(tween: Tween(begin: .6, end: 1.2), weight: 40),
//     //   TweenSequenceItem(tween: Tween(begin: 1.2, end: .9), weight: 25),
//     //   TweenSequenceItem(tween: Tween(begin: .9, end: 1), weight: 35),
//     // ]).animate(controller);

//     dropAnim = TweenSequence<double>([
//   TweenSequenceItem(
//     tween: Tween<double>(begin: liftHeight, end: 6.0)
//         .chain(CurveTween(curve: const Cubic(0.18, 0.8, 0.25, 1))),
//     weight: 45,
//   ),
//   TweenSequenceItem(
...
//   ),
// ]).animate(controller);
// shadowScale = TweenSequence<double>([
//   TweenSequenceItem(tween: Tween<double>(begin: .6, end: 1.2), weight: 40),
//   TweenSequenceItem(tween: Tween<double>(begin: 1.2, end: .9), weight: 25),
//   TweenSequenceItem(tween: Tween<double>(begin: .9, end: 1.0), weight: 35),
// ]).animate(controller);
//     shadowOpacity = Tween(begin: .35, end: .65).animate(controller);
...
//       builder: (_, child) {
//         final offset = widget.isDragging ? liftHeight : dropAnim.value;
